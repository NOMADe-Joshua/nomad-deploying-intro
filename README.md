![docker image](https://github.com/NOMADe-Joshua/nomad-deploying-intro/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/NOMADe-Joshua/nomad-deploying-intro.git
    cd nomad-deploying-intro
    ```

    or

    ```sh
    curl-L -o nomad-deploying-intro.zip "https://github.com/NOMADe-Joshua/nomad-deploying-intro/archive/main.zip"
    unzip nomad-deploying-intro.zip
    cd nomad-deploying-intro
    ```
...
your `docker-compose.yaml` with `ghcr.io/nomade-joshua/nomad-deploying-intro:main` for the services
...
```sh
docker pull ghcr.io/nomade-joshua/nomad-deploying-intro/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/NOMADe-Joshua/nomad-deploying-intro/manifests/main": unauthorized`
